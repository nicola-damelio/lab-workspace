...
const buildCloningNotebookHtml = (checked, ctx) => {
  ...
  if (checked.setup) {
    ...
    if (program.length) {
      html += `<h4 style="font-size: 12px; color: #334155; margin-bottom: 4px;">🌡️ Thermal Cycler Program ${t.lidTemp ? `(Lid: ${t.lidTemp} °C)` : ''}</h4>
    ...
    if (mix.length) {
      ...
      html += `<h4 style="font-size: 12px; color: #334155; margin-bottom: 4px;">🧪 Reaction Mix (total ${Math.round(total * 100) / 100} µL)</h4>
      <table style="width: 100%; border-collapse: collapse; margin-bottom: 12px; font-size: 11px; background: white;">
        <tr style="background-color: #f1f5f9;">
  ...
  if (checked.quant && Array.isArray(t.dnaQuantification) && t.dnaQuantification.length) {
    html += `<h4 style="font-size: 12px; color: #334155; margin-bottom: 4px;">💧 DNA Quantification</h4>
    <table style="width: 100%; border-collapse: collapse; margin-bottom: 12px; font-size: 11px; background: white;">
      <tr style="background-color: #f1f5f9;">
  ...
  if (checked.uv && Array.isArray(t.uvSpectra) && t.uvSpectra.length) {
    html += `<h4 style="font-size: 12px; color: #334155; margin-bottom: 4px;">📈 UV Spectra Analysis</h4>
    <table style="width: 100%; border-collapse: collapse; margin-bottom: 12px; font-size: 11px; background: white;">
      <tr style="background-color: #f1f5f9;">
