...
// --- COMPONENTE INTERVALLI TIPICI DI CHEMICAL SHIFT (grafico a barre, da peptide_NMR_simulator) ---
const ChemicalShiftRanges = ({ sequence }) => {
  ...
  // Altezza proporzionale al numero di residui unici: niente spazio vuoto sprecato per sequenze corte.
...
// --- FORMA GRAFICA PER LE BARRE DEI RANGE TIPICI (da peptide_NMR_simulator) ---
