...
export const buildNotebookHtml = (checked, ctx) => {
  ...
  if (checked.cond) {
    ...
    html += `<p style="font-size: 12px; color: #475569; margin-bottom: 8px;">
      ...
      <b>Blank OD:</b> ${typeof model.bgOD === 'number' ? model.bgOD.toFixed(4) : 'N/A'} |
        ...
        if (c.fit) {
          html += `<tr>
            ...
            <td style="padding: 6px; border: 1px solid #e2e8f0;">
              ${c.fit.ic50.toFixed(3)} ± ${(c.fit.se * (model.eScale || 1)).toFixed(3)}
            </td>
          </tr>`;
        }
      });
  ...
  return (
    <div id={`plate-report-${activeTest.id}`} className="flex flex-col gap-6">
      ...
      <CollapsibleSection title="Fitting" icon="📐" defaultOpen={true}>
        <div className="flex flex-col gap-6">
          {/* ===== ERROR MANAGEMENT (contains Manual SD) ===== */}
          <CollapsibleSection title="Error Management" icon="⚠️" defaultOpen={false}>
            <div className="flex flex-col gap-4">
              ...
              {/* Manual SD panel (inside Error Management) */}
              {showErrPanel && (
