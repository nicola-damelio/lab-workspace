              ...
              <div className={`flex flex-col gap-2 w-full`}>
                ...
                {driveConnected ? (
                  <div
                    ...
                    title="Google Drive connected — uploaded files are renamed and saved automatically, organised in folders that mirror the app (project / test / section / instance)"
                  >
                  ...
                  onConnectDrive && (
                    <button
                      ...
                      title="Connect Google Drive so uploaded images/documents are automatically renamed and saved into folders that mirror the app (project / test / section / instance)"
                    >
