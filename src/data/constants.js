...
//
//   A) SHARED "Lab Workspace" MODE (recommended for the lab — server/ folder):
...
//      opens the app. No scientist ever connects their OWN Google Drive — the
...
//           clicks "Connect Drive" — the server stores the credential.
//      Server requests used by the app:
//         POST { grant_type: 'workspace' }           → { access_token, expires_in }
