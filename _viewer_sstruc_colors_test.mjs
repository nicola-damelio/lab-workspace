...
eq(countOf(/SSTRUC_COLOR_ITEMS\.map\(\(it\) => \(/g), 3,
  'la roue ⚙, le rendu COMMUN des deux barres (styling et SÉLECTIONS : la même série de commandes, donc le même code) et le menu §2 dessinent la MÊME liste — le nombre est passé de 4 à 3 le jour où les deux barres ont partagé une seule implémentation');
